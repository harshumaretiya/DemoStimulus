...
class UserGenerator
    ...
    def forgot_password!(params)
      ...
      user.delay.send_reset_password_instructions if user.present?
    ...
    def send!(params, current_user, current_owner)
      ...
      params[:location_ids]&.each do |location_id|
        user.memberships.find_or_create_by(location_id: location_id) 
      end
    ...
    def resend_invite!(params)
      ...
      user.delay.invite! if !user.confirmed?
